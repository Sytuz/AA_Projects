...
def remarks_graphs():
    ...
    # Load data
    df1 = pd.read_csv("../data/exhaustive/exhaustive_p_125.csv")
    df2 = pd.read_csv("../data/exhaustive/exhaustive_p_25.csv")
    df3 = pd.read_csv("../data/exhaustive/exhaustive_p_50.csv")
    df4 = pd.read_csv("../data/exhaustive/exhaustive_p_75.csv")
